...
// Match build.appId
app.setAppUserModelId('poge7optimizer');
app.setAsDefaultProtocolClient('poge7optimizer');
...
const installExtensions = async () => {
    // electron-devtools-installer v2 downloads from Chrome Web Store which no longer
    // serves extensions via the old API — skip to avoid noisy startup errors
};
...
const createWindow = async () => {
    ...
    require('update-electron-app')({
        repo: 'RexQian/Fribbels-Epic-7-Optimizer',
