/*
Basic in-game constants. Not every reused constant lives here yet — prefer
adding new shared constants to this file instead of redeclaring them per-module.
*/

// setsByIndex is derived from setEnum so there is only one ordered list to maintain.
// When adding a new set: add it to setEnum in enums.js at the correct game-index
// position, then add the corresponding piece count to piecesBySetIndex below.
import { Sets as setEnum } from './enums';

const Constants = {
  // Ordered by game set index. Derived from setEnum (enums.js) — do NOT
  // duplicate here. Update enums.js setEnum to add/reorder sets.
  setsByIndex: Object.values(setEnum),

  piecesBySetIndex: [
    2, 2, 4, 4, 2, 2, 4, 4, 4, 2, 2, 4, 2, 2, 4, 4, 4, 2, 4, 4, 4, 2,
    // Fervor (2pc), Weakening (4pc)
    2, 4,
  ],
