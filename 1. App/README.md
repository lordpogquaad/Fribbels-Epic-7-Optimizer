...
You can edit existing gears or add new gears with the _Equip / Edit Item_ button, and filling in the relevant fields on this page.
...
The substat selections menu allows you to drag substats from the _Don't change_ column to either _Wanted_ or _Unwanted_. Unwanted substats will be converted into Wanted substats, which the Don't change ones will not be modified or selected for in the results.
