...
- **Use Copilot Chat for complex tasks**: Inline completions have minimal context. Chat mode can reference the workspace, open tabs, and explicitly attached files via #file references.

## Context Hints

- **Add a COPILOT.md file**: Document architecture decisions, patterns, and conventions Copilot should follow. When COPILOT.md conventions conflict with existing code, prefer COPILOT.md and flag the inconsistency for refactoring.
